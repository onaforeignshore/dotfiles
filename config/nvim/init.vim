...
abbr fitler filter
cabbrev w!! w !sudo tee % >/dev/null " sudo then write
...
set clipboard=unnamed       " integrate macOS clipboard

set wildmenu                " enhanced command line completion
set wildmode=list:longest   " complete files like a shell
set wildignore+=.git.       " ignore the .git directory
set wildignore+=*.DS_Store  " ignore Max finder/spotlight files
