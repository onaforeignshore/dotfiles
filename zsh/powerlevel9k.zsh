...
#P9K_MULTILINE_LAST_PROMPT_PREFIX_ICON="%{%F{9}%} ❯ %{%F{default}%} "
...
P9K_BACKGROUND_JOBS_EXPANDED=true

# Uncomment this line to always show the jobs count (even if it's zero).
#P9K_BACKGROUND_JOBS_VERBOSE_ALWAYS=true

P9K_BACKGROUND_JOBS_BACKGROUND="236"
P9K_BACKGROUND_JOBS_FOREGROUND="250"
...
# a P9K_DEFAULT_USER in your ~/.zshrc.

#P9K_CONTEXT_ALWAYS_SHOW=true                               # Always show this segment, including $USER and hostname.
#P9K_CONTEXT_ALWAYS_SHOW_USER=true                          # Always show the username, but conditionalize the hostname.
...
#                                    "/MyS..cts/Awe..les/BoringOffice", if P9K_DIR_SHORTEN_LENGTH=3 is also
...
#                                    controlled by P9K_DIR_SHORTEN_LENGTH.
...
#                                    sequence.
#     truncate_with_folder_marker    Search for a file that is specified by P9K_DIR_SHORTEN_FOLDER_MARKER and
...
P9K_DIR_SHORTEN_STRATEGY="truncate_from_left"               # How the directory strings should be truncated. See the table above for more information.
...
#P9K_DIR_SHORTEN_FOLDER_MARKER='.shorten_folder_marker'     # Filename to use to indicate where to shorten the path when using "truncate_with_folder_marker".
#P9K_DIR_SHORTEN_DELIMITER="\u2026"                         # …
P9K_DIR_SHORTEN_DELIMITER="…"                               # …

P9K_DIR_HOME_FOLDER_ABBREVIATION="~"

#P9K_DIR_PATH_ABSOLUTE=true                                 # uncomment this if you want to use absolute paths instead of home folder abbreviations.
#P9K_DIR_OMIT_FIRST_CHARACTER=true                          # omit the first character (usually a slash that gets replaced if you set P9K_DIR_PATH_SEPARATOR)
...
#P9K_STATUS_CROSS=true                                      # uncomment this line to use a cross instead of a carriage return note that this hides the error code and pipestatus
...
#P9K_STATUS_VERBOSE=false                                   # uncomment this line to hide this segment when the last command completed successfully by setting P9K_STATUS_OK_IN_NON_VERBOSE to false.
#P9K_STATUS_OK_IN_NON_VERBOSE=true                          # uncomment this line to show this segment when the last command completed successfully in non-verbose mode.
...
#P9K_TIME_FORMAT="%D{%H:%M:%S \uf073  %d.%m.%y}"            # Output time, date, and a symbol  from the "Awesome Powerline Font" set
...
P9K_TW_FINISHEDALL_BACKGROUND="22"
P9K_TW_FINISHEDALL_FOREGROUND="250"
P9K_TW_FINISHEDALL_ICON="\uF046"
P9K_TW_FINISHEDALL_ICON_COLOR="255"
#P9K_TW_FINISHEDALL_BOLD=true

P9K_TW_FINISHEDTODAY_BACKGROUND="24"
P9K_TW_FINISHEDTODAY_FOREGROUND="250"
P9K_TW_FINISHEDTODAY_ICON="\uF046"
P9K_TW_FINISHEDTODAY_ICON_COLOR="255"
#P9K_TW_FINISHEDTODAY_BOLD=true

P9K_TW_TODAYPENDING_BACKGROUND="130"
P9K_TW_TODAYPENDING_FOREGROUND="250"
P9K_TW_TODAYPENDING_ICON="\uF046"
P9K_TW_TODAYPENDING_ICON_COLOR="255"
#P9K_TW_TODAYPENDING_BOLD=true

P9K_TW_TODAYONLY_BACKGROUND="166"
P9K_TW_TODAYONLY_FOREGROUND="250"
P9K_TW_TODAYONLY_ICON="\uF046"
P9K_TW_TODAYONLY_ICON_COLOR="255"
#P9K_TW_TODAYONLY_BOLD=true

P9K_TW_LATE_BACKGROUND="88"
P9K_TW_LATE_FOREGROUND="250"
P9K_TW_LATE_ICON="\uF046"
P9K_TW_LATE_ICON_COLOR="255"
#P9K_TW_LATE_BOLD=true

# *****  user  *****
# This segment displays the current user.

P9K_USER_ALWAYS_SHOW=true
#P9K_USER_ALWAYS_SHOW_USER=true
#P9K_USER_TEMPLATE="%n"
...
P9K_USER_REMOTE_BACKGROUND="21"
P9K_USER_REMOTE_FOREGROUND="250"
P9K_USER_REMOTE_ICON="\uF2C0"                              # F007  / F2C0 
P9K_USER_REMOTE_ICON_COLOR="255"
P9K_USER_REMOTE_BOLD=true

P9K_USER_REMOTESUDO_BACKGROUND="166"
P9K_USER_REMOTESUDO_FOREGROUND="250"
P9K_USER_REMOTESUDO_ICON="\uF13E"                                 # F09C  / F13E  /
P9K_USER_REMOTESUDO_ICON_COLOR="255"
P9K_USER_REMOTESUDO_BOLD=true
...
#P9K_VCS_HIDE_BRANCH_ICON=true                              # set to hide the branch icon from the segment.
#P9K_VCS_SHOW_CHANGESET=true                                # set to display the hash/changeset in the segment.
#P9K_VCS_CHANGESET_HASH_LENGTH=6                            # How many characters of the hash/changeset to display in the segment.
P9K_VCS_SHOW_SUBMODULE_DIRTY=true                           # set to reflect submodule status in the top-level repository prompt.
...
#P9K_SYMFONY2_VERSION_BACKGROUND=""
#P9K_SYMFONY2_VERSION_FOREGROUND=""
P9K_SYMFONY2_VERSION_ICON="\uE757"                          # E757 
#P9K_SYMFONY2_VERSION_ICON_COLOR=""
...
#P9K_ANACONDA_FOREGROUND=""                                 # Note that you can modify the _FOREGROUND color without affecting the icon color.
#P9K_ANACONDA_ICON=""
...
# P9K_AWS_DEFAULT_PROFILE in your ~/.zshrc

#P9K_AWS_DEFAULT_PROFILE=""                                 # your AWS profile name
...
if [[ "${TERM}" =~ "tmux" || "${TERM}" =~ "screen" ]]; then
  # Segment list for left prompt
  P9K_LEFT_PROMPT_ELEMENTS=(os_icon dir background_jobs command_execution_time vi_mode)
  # Segment list for right prompt
  P9K_RIGHT_PROMPT_ELEMENTS=(status vcs rbenv pyenv history tw)
else
  # Segment list for left prompt
  P9K_LEFT_PROMPT_ELEMENTS=(os_icon host user dir background_jobs command_execution_time vcs vi_mode)
  # Segment list for right prompt
  P9K_RIGHT_PROMPT_ELEMENTS=(status rbenv pyenv history tw date time battery)
fi
